<template>
  <form @submit="formSubmit">
    <div>
      <CardTitle :title="$t('setting_general_page.app_configuration_settings')" icon="fa-solid fa-sliders"></CardTitle>
    </div>
...
//fetch data
const data = ['is_event', 'is_blog', 'is_user_push_notification', 'is_provider_push_notification', 'enable_chat_gpt', 'test_without_key', 'chatgpt_key']
