                            ...
                            <x-slot name="toolbar">
                                ...
                                @hasPermission('add_page')
                                    <x-buttons.offcanvas target='#form-offcanvas'
                                        title="{{ __('Create') }} {{ __('page.lbl_role') }}">{{ __('messages.new') }}</x-buttons.offcanvas>
                                @endhasPermission
                            </x-slot>
                        </x-backend.section-header>
                            ...
                            @if ($role->name !== 'admin')
                                ...
                                <div class="accordion-item" id="permission_{{ $role->id }}">
                                    ...
                                    <a class="btn btn-soft-info btn-sm" onclick="reset_permission({{ $role->id }})"
                                        data-bs-toggle="tooltip" title="{{ __('Reset Permission') }}"> <i
                                            class="fas fa-undo"></i>
                                        Reset</a>
                                            ...
                                            @foreach ($modules as $module)
                                                <div class="row  m-3   align-items-center permission_data">
                                                    ...
                                                    <div class="col-md-2 more_field">
                                                        <button
                                                            class="accordion-button {{ $decodedData != '' ? '' : 'accordion_btn' }}"
