...
<body class="bg-light">
    ...
    <div class="container mt-5 mb-5">
        <section class="row justify-content-center align-items-center align-content-center">
            <div class="col-11 col-lg-6 border bg-white rounded">
                ...
                <div class="form-group border rounded-pill p-1">
                    <label class="form-label ms-5 mt-2" for="chip">{{ __('pet.pet_chip') }}</label>
                    <h4 class="ms-5">{{ isset($pet->chip) ? $pet->chip->num_identificacion : __('pet.unassigned') }}
                    </h4>
                </div>
                ...
                <div class="form-group p-3 border-bottom">
                    ...
                    <p class="descriptions">{{ !is_null($pet->breed) ? $pet->breed->name : __('pet.unspecified') }}</p>
                </div>
                ...
                <div class="form-group p-3 border-bottom">
                    ...
                    <p class="descriptions">{{ !is_null($pet->pet_fur) ? $pet->pet_fur : __('pet.unspecified') }}</p>
                </div>
                    ...
                    @foreach ($pet->diario->sortByDesc('date') as $diario)
                        <div class="border rounded mb-3">
                            ...
                            <div class="col-12 form-group p-3 border-bottom">
                                ...
                                <p class="descriptions">
                                    {{ !is_null($diario->actividad) ? $diario->actividad : __('pet.unspecified') }}</p>
                            </div>
