    ...
    <div class="container mt-5 mb-5">
        <section class="row justify-content-center align-items-center align-content-center">
            <div class="col-12 col-lg-6 border bg-white rounded p-0">
                {{-- Esto es las condiciones de permisologia --}}
                {{-- @if ($pet->permission_pet_profile && !is_null($pet->permission_pet_profile->expiration) && \Carbon\Carbon::parse($pet->permission_pet_profile->expiration)->isFuture())
                @else
                    <div class="row justify-content-center align-items-center align-content-center">
                        <div class="col-11 p-3 align-items-center align-content-center" style="height: 400px;">
                            <h3 class="text-center">Opps, ha caducado los permisos para ver este perfil</h3>
                        </div>
                    </div>
                @endif --}}
                ...
                <div class="form-group">
                    <div class="text-center">
                        <img src="{{ $pet->pet_image }}" alt="{{$pet->name}}" class="img-fluid w-100 pet-image" />
                    </div>
                </div>
                ...
                <div class="border container-pet position-relative p-3 border">
                    ...
                    <div class="form-group p-3 border-bottom">
                        ...
                        <p class="descriptions">
                            {{ !is_null($pet->breed) ? $pet->breed->name : __('pet.unspecified') }}
                        </p>
                    </div>
                    ...
                    <div class="form-group p-3 border-bottom">
                        ...
                        <p class="descriptions">
                            {{ !is_null($pet->pet_fur) ? $pet->pet_fur : __('pet.unspecified') }}
                        </p>
                    </div>
                    ...
                    <div class="form-group p-3 border-bottom">
                        ...
                        <p class="descriptions">
                            {{ !is_null($pet->weight) ? $pet->weight : __('pet.unspecified') }}
                    ...
                    <div class="form-group p-3 border-bottom">
                        ...
                        <p class="descriptions">
                            {{ !is_null($pet->height) ? $pet->height : __('pet.unspecified') }}
                    ...
                    {{-- Permisologia para ver tratamientos medicos
                    @if ($pet->permission_pet_profile->permission_profile->description == 'Administrador' || $pet->permission_pet_profile->permission_profile->description == 'Visualizar Perfil' || $pet->permission_pet_profile->permission_profile->description == 'Datos Médicos')
                    @endif --}}
                    ...
                    {{-- Permisologia para ver entrenamientos --}}
                    {{-- @if ($pet->permission_pet_profile->permission_profile->description == 'Administrador' || $pet->permission_pet_profile->permission_profile->description == 'Visualizar Perfil' || $pet->permission_pet_profile->permission_profile->description == 'Entramientos')
                            ...
                            @foreach ($pet->diario->sortByDesc('date') as $index => $diario)
                                <div class="border services mb-3 col-5 me-auto">
                                    ...
                                    <div class="col-12 form-group p-2">
                                        ...
                                        <p class="descriptions">
                                            {{ !is_null($diario->notas) ? $diario->notas : __('pet.unspecified') }}
                                        </p>
                                    </div>
                                </div>
                            @endforeach
