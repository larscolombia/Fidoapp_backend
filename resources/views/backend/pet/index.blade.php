    ...
    <div class="container mt-5 mb-5">
        <section class="row justify-content-center align-items-center align-content-center">
            <div class="col-12 col-lg-6 border bg-white rounded p-0">
                ...
                @if (
                    $pet->permission_pet_profile &&
                        !is_null($pet->permission_pet_profile->expiration) &&
                        \Carbon\Carbon::parse($pet->permission_pet_profile->expiration)->isFuture())
                    ...
                    <div class="border container-pet position-relative p-3 border">
                        ...
                        @if (
                            $pet->permission_pet_profile->permission_profile->description == 'Administrador' ||
                                $pet->permission_pet_profile->permission_profile->description == 'Visualizar Perfil' ||
                                $pet->permission_pet_profile->permission_profile->description == 'Datos Médicos')
                        ...
                        @if (
                            $pet->permission_pet_profile->permission_profile->description == 'Administrador' ||
                                $pet->permission_pet_profile->permission_profile->description == 'Visualizar Perfil' ||
                                $pet->permission_pet_profile->permission_profile->description == 'Entramientos')
                            <div class="row p-1 ms-3">
                                ...
                                @if (count($pet->diario) > 0)
                                    @foreach ($pet->diario->sortByDesc('date') as $index => $diario)
                                        <div class="border services mb-3 col-5 me-auto">
                                            ...
                                            <div class=" form-group p-2 ">
                                                <label for="date"
                                                    class="form-label">{{ __('pet.category') }}</label>
                                                <p class="descriptions">
                                            ...
                                            <div class="col-12 form-group p-2 ">
                                                <label for="activity"
                                                    class="form-label">{{ __('pet.activity') }}</label>
                                                <p class="descriptions">
