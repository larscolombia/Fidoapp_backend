        ...
        <div class="card-body">
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    <x-buttons.show route='{!! route("backend.$module_name.show", $$module_name_singular) !!}' title="{{ __('Show') }} {{ __($module_title) }}"
                        class="ms-1" />
                </x-slot>
            </x-backend.section-header>
            <hr>
                        ...
                        <div class="col-12 col-sm-10">
                            <div class="form-group">
                                <a href="{{ route('backend.users.changePassword', $user->id) }}"
                                    class="btn btn-outline-primary btn-sm"><i class="icon-password"></i> Change password</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-8">
                                <div class="float-end">
                                    @if ($$module_name_singular->status != 2 && $$module_name_singular->id != 1)
                                        <a href="{{ route('backend.users.block', $$module_name_singular) }}"
                                            class="btn btn-danger" data-method="PATCH" data-token="{{ csrf_token() }}"
                                            data-bs-toggle="tooltip" title="{{ __('labels.backend.block') }}"
                                            data-confirm="{{ __('messages.are_you_sure?') }}"><i
                                                class="fas fa-ban"></i></a>
                                    @endif
                                    @if ($$module_name_singular->status == 2)
                                        <a href="{{ route('backend.users.unblock', $$module_name_singular) }}"
                                            class="btn btn-info" data-method="PATCH" data-token="{{ csrf_token() }}"
                                            data-bs-toggle="tooltip" title="{{ __('labels.backend.unblock') }}"
                                            data-confirm="{{ __('messages.are_you_sure?') }}"><i class="fas fa-check"></i>
                                            Unblock</a>
                                    @endif
                                    ...
                                    @if ($$module_name_singular->id != 1)
                                        <a href="{{ route("backend.$module_name.destroy", $$module_name_singular) }}"
                                            ...
                                            data-bs-toggle="tooltip" title="{{ __('labels.backend.delete') }}"> <i
