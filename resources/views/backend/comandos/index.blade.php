            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 w-100">
                <div class="d-flex flex-wrap align-items-center">
                    ...
                    <div class="me-3 mb-2" style="min-width: 150px;">
                        <label for="filter_is_favorite"
                            class="form-label">{{ __('comando_entrenamiento.is_favorite') }}</label>
                ...
                <div class="mb-2">
                    @hasPermission('add_comandos')
                        <a class="btn btn-primary"
                            href="{{ route('backend.comandos.create') }}">{{ __('comando_entrenamiento.create') }}</a>
                    @endhasPermission
                </div>
            </div>
