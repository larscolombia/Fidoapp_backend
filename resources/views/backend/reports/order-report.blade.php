            ...
            <x-backend.section-header>
                    ...
                    <div class="col-md-3">
                        <div class=" input-group gap-2 flex-nowrap">
                            <input type="text" name="order_date" id="order_date"
                                placeholder="{{ __('messages.select_date') }}" class="order-report-date-range form-control"
                                readonly />
                ...
                <x-slot name="toolbar">
                    ...
                    <div class="input-group flex-nowrap">
                        <h5>{{ __('product.total_amount') }} <strong>{{ \Currency::format($totalAdminEarnings) }}</strong>
                        </h5>
                    </div>
