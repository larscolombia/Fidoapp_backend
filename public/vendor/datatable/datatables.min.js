...
$jscomp.polyfillIsolated = function (l, z, A, q) {
  ...
  z = z(A)
  null != z && (l ? $jscomp.defineProperty($jscomp.polyfills, E, { configurable: !0, writable: !0, value: z }) : z !== A && (($jscomp.propertyToPolyfillSymbol[E] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(E) : $jscomp.POLYFILL_PREFIX + E), (E = $jscomp.propertyToPolyfillSymbol[E]), $jscomp.defineProperty(q, E, { configurable: !0, writable: !0, value: z })))
}
$jscomp.polyfill(
...
;(function (l) {
  ...
  function ma(a) {
    ...
    if (a) {
      ...
      !a.sEmptyTable && d && 'No hay registros disponibles en esta tabla' === b.sEmptyTable && X(a, a, 'sZeroRecords', 'sEmptyTable')
  ...
  function Za(a) {
    ...
    if (d || (!t && !h && !e && g == oa(a) && g == m.length)) for (v = 0; v < g; v++) (k = ta(a, v)), null !== k && (c[k].sWidth = K(m.eq(v).width()))
      ...
      for (v = 0; v < k.length; v++) (w = c[k[v]]), (m[v].style.width = null !== w.sWidthOrig && '' !== w.sWidthOrig ? K(w.sWidthOrig) : ''), w.sWidthOrig && h && l(m[v]).append(l('<div/>').css({ width: w.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }))
  ...
  u.defaults = {
    ...
    iTabIndex: 0,
    oClasses: {},
    oLanguage: { oAria: { sSortAscending: ': activate to sort column ascending', sSortDescending: ': activate to sort column descending' }, oPaginate: { sFirst: 'First', sLast: 'Last', sNext: 'Next', sPrevious: 'Previous' }, sEmptyTable: 'No hay registros disponibles en esta tabla', sInfo: 'Showing _START_ to _END_ of _TOTAL_ entries', sInfoEmpty: 'Showing 0 to 0 of 0 entries', sInfoFiltered: '(filtered from _MAX_ total entries)', sInfoPostFix: '', sDecimal: '', sThousands: ',', sLengthMenu: 'Show _MENU_ entries', sLoadingRecords: 'Cargando...', sProcessing: 'Procesando...', sSearch: 'Search:', sSearchPlaceholder: '', sUrl: '', sZeroRecords: 'No matching records found' },
  ...
  u.ext = M = { buttons: {}, classes: {}, build: 'bs5/dt-1.11.5', errMode: 'alert', feature: [], search: [], selector: { cell: [], column: [], row: [] }, internal: {}, legacy: { ajax: null }, pager: {}, renderer: { pageButton: {}, header: {} }, order: {}, type: { detect: [], search: {}, order: {} }, _unique: 0, fnVersionCheck: u.fnVersionCheck, iApiIndex: 0, oJUIClasses: {}, sVersion: u.version }
