...
class CommonNotification extends Notification implements ShouldQueue
{
    ...
    public function toOneSignal($notifiable)
    {
        ...
        return onesingle([
            'app_id' => $notifiable->user_type == 'user' || $notifiable->user_type == 'admin' ? setting('onesignal_app_id') : setting('employee_onesignal_app_id'),
            'include_player_ids' => [$notifiable->player_id],
            'data' => [
                'type' => $this->subject,
                 'additional_data' => $this->data
               // 'id' => $this->data['id'],
               // 'notification_group'=> $this->data['notification_group']
            ],
            'headings' => [
                'en' => $heading,
            ],
