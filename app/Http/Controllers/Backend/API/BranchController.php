...
class BranchController extends Controller
{
    ...
    {
        $branchId = !empty($request->branch_id) ? $request->branch_id: get_pet_center_id();
    ...
    public function branchConfig(Request $request)
    {
        ...
        $branch_tax = Tax::active()->whereNull('module_type')->orWhere('module_type', 'services')->get();
        $tax = TaxResource::collection($branch_tax);
