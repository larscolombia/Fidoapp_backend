...
class NotificationsController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = __('notification.title');
    ...
    public function index()
    {
        ...
        $module_title = $module_title.'('.$total.')';
    ...
    public function deleteAll()
    {
        ...
        Flash::success("<i class='fas fa-check'></i> Todas las notificaciones eliminadas")->important();
    ...
    public function notificationRemove($id)
    {
        ...
        // return back();
        // return redirect("app/$module_name")->with('flash_success', "Notification Deleted!");
