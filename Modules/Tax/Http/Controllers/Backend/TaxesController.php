...
class TaxesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tax::backend.tax.index_datatable', compact('module_action', 'filter'));
    }
    ...
    public function index_list(Request $request)
    {
        ...
        $query_data = Tax::where('name', 'LIKE', "%$term%")->orWhere('slug', 'LIKE', "%$term%")->limit(7)->get();
    ...
    {
        $query = Tax::query()->orderBy('updated_at', 'desc');
