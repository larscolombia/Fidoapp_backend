...
class CustomersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('customer::backend.customers.index', compact('module_action', 'columns', 'customefield'));
    }
        ...
        $datatable = $datatable->eloquent($query)
            ...
            ->editColumn('email_verified_at', function ($data) {
                ...
                if ($data->email_verified_at) {
                    return '<span class="badge booking-status bg-soft-success p-3"> '.__('customer.msg_verified').'</span>';
                }
