...
@section('content')
        ...
        <div class="card-body">
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    @hasPermission('add_city')
                        <x-buttons.offcanvas target='#form-offcanvas'
                            title="{{ __('messages.create') }} {{ __($module_title) }}">
                            {{ __('messages.create') }} {{ __('city.singular_title') }}</x-buttons.offcanvas>
                    @endhasPermission
                </x-slot>
            </x-backend.section-header>
    ...
    <div data-render="app">
        <city-form-offcanvas create-title="{{ __('messages.create') }} {{ __($module_title) }}"
