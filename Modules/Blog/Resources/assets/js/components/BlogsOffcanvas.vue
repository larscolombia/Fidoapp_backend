      ...
      <div class="offcanvas-body">
        ...
        <div class="form-group">
          <div class="text-center">
            <img :src="ImageViewer || props.defaultImage" alt="blog-image"
              class="img-fluid mb-2 avatar avatar-140 avatar-rounded" />
          </div>
          <label class="form-label" for="blog_image">{{ $t('blog.lbl_blog_image') }}</label>
          <input type="file" class="form-control" name="blog_image" id="blog_image" @change="fileUpload"
        ...
        <InputField class="col-md-12" type="text" :is-required="true" :label="$t('blog.lbl_blog_name')" placeholder=""
        ...
        <div class="form-group">
          ...
          <Multiselect id="tags" v-model="tags" :multiple="true" :value="tags" placeholder="Enter Tags"
            v-bind="multiSelectOption" :options="tags_list.options" class="form-group">
          </Multiselect>
        ...
        <div class="form-group">
          ...
          <input type="url" class="form-control" v-model="video" id="video" name="video">
          <!-- <label for="video" class="form-label">{{ $t('course_platform.video') }}</label>
        ...
        <div class="form-group">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="form-check form-switch">
              <input class="form-check-input" :value="status" :checked="status" name="status" id="blog-status"
