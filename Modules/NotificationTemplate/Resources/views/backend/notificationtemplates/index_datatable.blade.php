    ...
    <div class="card">
        <div class="card-header">
            <x-backend.section-header>
                    ...
                    <div>
                        <div class="datatable-filter">
                            <select name="column_status" id="column_status" class="select2 form-control"
                                ...
                                <option value="">{{ __('notification.all') }}</option>
                ...
                <a href='{{ route("backend.notification-templates.create") }}' class="btn btn-primary d-flex align-items-center gap-1" title="{{__('Create')}}  {{ __($module_title) }}"><i class="icon-add-new"></i>{{__('Create New')}}</a>
              @endhasPermission --}}
                </x-slot>
            </x-backend.section-header>
        </div>
    ...
    <script type="text/javascript" defer>
        const columns = [{
            ...
            },
            {
                data: 'type',
                name: 'type',
                title: "{{ __('notification.lbl_type') }}"
            },
            {
                data: 'status',
                name: 'status',
