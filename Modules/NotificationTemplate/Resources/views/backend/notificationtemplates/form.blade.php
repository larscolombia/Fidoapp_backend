        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <select name="type" class="form-control select2" id="type" onchange="onChangeType()"
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label>{{ __('messages.parameters') }} :</label><br>
                    <div class="main_form">
    ...
    <div class="row">
        <div class="col-md-12 pt-2">
            ...
            <button onclick="window.history.back();" class="btn btn-outline-primary"><i
                    class="fa-solid fa-angles-left"></i> {{ __('messages.close') }}<i
                    class="md md-lock-open"></i></button>
        </div>
    </div>
</div>
