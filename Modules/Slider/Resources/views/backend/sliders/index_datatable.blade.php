...
@section('content')
    ...
    <div data-render="app">
        <slider-form-offcanvas create-title="{{ __('messages.create') }} {{ __($module_title) }}"
    ...
    <script type="text/javascript">
        const columns = [{
            ...
            },
            {
                data: 'name',
                name: 'name',
                title: "{{ __('slider.lbl_name') }}",
                width: '15%'
            },
            {
                data: 'link',
                name: 'link',
                title: "{{ __('slider.lbl_link') }}",
                width: '15%'
            },
            {
                data: 'type',
                name: 'type',
                title: "{{ __('slider.lbl_type') }}",
                width: '15%'
            },
            {
                data: 'link_id',
                name: 'link_id',
                title: "{{ __('slider.lbl_link_id') }}",
                width: '15%'
            },
            {
                data: 'status',
                name: 'status',
                title: "{{ __('slider.lbl_status') }}",
                width: '15%'
            },
