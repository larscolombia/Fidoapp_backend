...
class OrderItemResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'get_product_price'=> $this->product_variation ? getDiscountedProductPrice($this->product_variation->price, $this->product_variation->product_id) : 0,
            'product_amount' =>$this->product_variation ? getDiscountedProductPrice($this->product_variation->price,$this->product_variation->product_id)*$this->qty : 0,
