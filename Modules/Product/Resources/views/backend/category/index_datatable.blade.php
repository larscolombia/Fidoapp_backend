...
@section('content')
            ...
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    @hasPermission('add_product_category')
                        <button type="button" class="btn btn-primary" data-crud-id="{{ 0 }}"><i
                                class="fas fa-plus-circle"></i> {{ __('messages.create') }}
    ...
    <div data-render="app">
        <category-form-offcanvas default-image="{{ default_feature_image() }}"
            ...
            edit-title="{{ __('messages.edit') }} {{ __('category.singular_title') }} "
