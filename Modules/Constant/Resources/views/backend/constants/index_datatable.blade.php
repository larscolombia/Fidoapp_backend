                ...
                <x-slot name="toolbar">
                    ...
                    <button class="btn btn-outline-primary btn-group" data-bs-toggle="offcanvas"
                        data-bs-target="#offcanvasExample" aria-controls="offcanvasExample"><i
                            class="fa-solid fa-filter"></i> Advance Filter</button>
                </x-slot>
            </x-backend.section-header>
        </div>
    ...
    <script type="text/javascript">
        const columns = [{
            ...
            },
            {
                data: 'type',
                name: 'type',
                title: "{{ __('constant.lbl_type') }}"
            },
            {
                data: 'name',
                name: 'name',
                title: "{{ __('constant.lbl_name') }}"
            },
            {
                data: 'value',
                name: 'value',
                title: "{{ __('constant.lbl_value') }}"
            },
            {
                data: 'status',
                name: 'status',
                orderable: false,
                searchable: true,
                title: "{{ __('constant.lbl_status') }}"
            },
            {
                data: 'updated_at',
                name: 'updated_at',
                title: "{{ __('constant.lbl_updated_at') }}"
            },
        ]
