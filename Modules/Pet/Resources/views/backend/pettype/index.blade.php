...
@section('content')
            ...
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    <x-buttons.offcanvas target='#form-offcanvas' class=" d-flex align-items-center gap-1"
                        title="{{ __('Create') }} {{ __($create_title) }}">{{ __('messages.new') }}</x-buttons.offcanvas>
    ...
    <div data-render="app">
        <pet-type-offcanvas create-title="{{ __('messages.create') }} {{ __($create_title) }}"
