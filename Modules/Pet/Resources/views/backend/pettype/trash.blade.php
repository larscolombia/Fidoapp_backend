        ...
        <div class="card-body">
            ...
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    <a href='{{ route("backend.pet.$module_name.index") }}' class="btn btn-secondary" data-bs-toggle="tooltip"
            ...
            <div class="row mt-4">
                <div class="col">
                    <table id="datatable" class="table table-bordered table-hover table-responsive">
                        ...
                        <tbody>
                            @foreach ($data as $module_name_singular)
                                <tr>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route("backend.pet.$module_name.restore", $module_name_singular) }}"
                                            class="btn btn-warning btn-sm" data-type="ajax" data-method="get"
            ...
            <div class="row">
                <div class="col-7">
                    <div class="float-left">
                        Total {{ $data->total() }} {{ __($module_name) }}
                    </div>
                </div>
                <div class="col-5">
                    <div class="float-end">
