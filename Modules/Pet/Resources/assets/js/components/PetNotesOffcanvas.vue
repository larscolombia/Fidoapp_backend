    ...
    <form>
      <div class="offcanvas offcanvas-end offcanvas-booking" tabindex="-1" id="pet-notes-form" aria-labelledby="form-offcanvasLabel">
        ...
        <div class="offcanvas-body">
          ...
          <span class="btn btn-sm text-primary border-0 px-0 float-end" data-bs-toggle="offcanvas" data-bs-target="#add-pet-notes-form"  aria-controls="form-offcanvas" > <i class="fa-solid fa-plus"></i> Agregar notas</span>
          ...
          <div class="form-group d-inline-block w-100">
            <div v-if="!IsLoading" class="d-grid">
                 ...
                 <div  v-for="(item, index) in NoteList" :key="item" >
                  <div v-if="item.is_private==0 || (item.is_private==1 && item.created_by== AuthId()) || role()=='admin' || role()=='demo_admin'" class="list-group-item bg-soft-primary text-body rounded mb-3 border-0 d-flex justify-content-between gap-3">
                    ...
                    <div class="flex-shrink-0">
                      ...
                      <span v-if="item.created_by==AuthId() || role()=='admin' ||  role()=='demo_admin'" class="fs-4 text-danger border-0 bg-transparent" @click="removePetNotes(item.id, '¿Estás seguro de que quieres eliminarlo?')"  data-bs-toggle="tooltip"> <i class="icon-delete"></i></span>
             ...
             <div v-else class="text-center">
                   <p>Las notas no están disponibles</p>
             </div>
            </div>
