        ...
        <div class="row">
          <div class="col-12">
            <div class="form-group">
              ...
              <label class="form-label" for="feature_image">{{$t('category.lbl_feature_image')}} <span class="text-danger">*</span> </label>
...
const validationSchema = yup.object({
  ...
  // feature_image : yup.string().test('Category image is required' , function(value) {
