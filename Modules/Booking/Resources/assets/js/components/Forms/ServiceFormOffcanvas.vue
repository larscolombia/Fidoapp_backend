<template>
    <form @submit="formSubmit">
      <div class="offcanvas offcanvas-end offcanvas-booking" tabindex="-1" id="service-offcanvas" aria-labelledby="form-offcanvasLabel">
  ...
  const reset_datatable_close_offcanvas = (res) => {
    if (res.status) {
      ...
      bootstrap.Offcanvas.getInstance('#service-offcanvas').hide()
      setFormData(defaultData())
    } else {
  ...
  useOnOffcanvasHide('service-offcanvas', () => setFormData(defaultData()))
  </script>
