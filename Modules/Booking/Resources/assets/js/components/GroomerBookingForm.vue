        ...
        <div class="offcanvas-body border-top">
          ...
          <div v-if="selectedCustomer">
            ...
            <div class="col-md-12 form-group">
              ...
              <Multiselect id="service" v-model="service" @select="checkTotalAmount" :value="service" :placeholder="$t('branch.select_service')" v-bind="SingleSelectOption" :options="service_list.options" class="form-group"></Multiselect>
...
const validationSchema = yup.object({
  ...
  service: yup.string().required(getTranslation('required')),
