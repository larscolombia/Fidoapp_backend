...
@section('content')
    <div class="card">
                ...
                <x-slot name="toolbar">
                    ...
                    <div class="input-group flex-nowrap">
                        ...
                        <input type="text" class="form-control form-control-sm dt-search"
                            ...
                            aria-label="{{ __('message.search') }}" aria-describedby="addon-wrapping">
        ...
        <div data-render="app">
            <vat-form create-title="{{ __('messages.create') }} {{ __($create_title) }}"
                edit-title="{{ __('messages.edit') }} {{ __('booking.lbl_veterinary') }} {{ __('booking.singular_title') }} "></vat-form>
        </div>
    </div>
@endsection
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        const columns = [{
            ...
            {
                data: 'veterinary_type',
                name: 'veterinary_type',
                title: "{{ __('booking.lbl_veterinary_type') }}",
                searchable: true,
            },
            {
                data: 'service_amount',
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            initDatatable({
                url: '{{ route('backend.veterinary.index_data') }}',
                finalColumns,
                orderColumn: [
                    [9, 'desc']
                ],
