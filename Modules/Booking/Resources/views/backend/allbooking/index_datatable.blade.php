...
<div class="card">
  ...
  <div data-render="app">
        <booking-form create-title="{{ __('messages.create') }} {{ __('booking.lbl_boading') }} {{ __('booking.singular_title') }} "
...
<script type="text/javascript">
  ...
  document.addEventListener('DOMContentLoaded', (event) => {
    initDatatable({
      url: '{{ route("backend.booking.index_data",["commission_employee_id" => $commission_employee_id]) }}',
      finalColumns,
      orderColumn: [[ 8, 'desc' ]],
      advanceFilter: () => {
        return {
