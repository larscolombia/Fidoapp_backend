...
@section('content')
    <div class="card">
        ...
        <div data-render="app">
            <trainer-form create-title="{{ __('messages.create') }} {{ __($create_title) }} "
                edit-title="{{ __('messages.edit') }} {{ __('booking.lbl_training') }} {{ __('booking.singular_title') }}"></trainer-form>
        </div>
    </div>
@endsection
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            initDatatable({
                url: '{{ route('backend.training.index_data') }}',
                finalColumns,
                orderColumn: [
                    [10, 'desc']
                ],
