                        ...
                        <div>
                            <div class="datatable-filter">
                                <select name="column_service_type" id="column_service_type" class="select2 form-control"
                                    data-filter="select" style="width: 100%">
                                    <option value="all" {{ $filter['column_service_type'] == 'all' ? 'selected' : '' }}>
                                        {{ __('product.all') }}</option>
                                    <option value="added_by_me"
                                        {{ $filter['column_service_type'] == 'added_by_me' ? 'selected' : '' }}>
                                        {{ __('messages.added_by_me') }}</option>
                                    <option value="assign_by_admin"
                                        {{ $filter['column_service_type'] == 'assign_by_admin' ? 'selected' : '' }}>
