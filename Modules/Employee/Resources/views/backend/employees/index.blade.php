                    ...
                    <div>
                      <div class="datatable-filter">
                        <select name="column_status" id="column_status" class="select2 form-control p-10" data-filter="select" style="width: 100%">
                          ...
                          <option value="{{ $value->id }}" {{$filter['commission'] == $value->title ? "selected" : ''}}>{{ $value->title }}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
...
@if($type !='')
    <employee-offcanvas type="{{ __($type) }}"  default-image="https://dummyimage.com/600x300/cfcfcf/000000.png" create-title="{{ __('messages.create') }} {{ __($create_title) }}" edit-title="{{ __('messages.edit') }} {{ __($create_title) }}" :customefield="{{ json_encode($customefield) }}">
    </employee-offcanvas>
    @else
    <employee-offcanvas type="{{ __('staff') }}"  default-image="https://dummyimage.com/600x300/cfcfcf/000000.png" create-title="{{ __('messages.create') }} {{ __($create_title) }}" edit-title="{{ __('messages.edit') }} {{ __($create_title) }}" :customefield="{{ json_encode($customefield) }}">
    </employee-offcanvas>
    @endif
